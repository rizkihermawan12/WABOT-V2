...
*/
const XPTN = 'BOT RIZKOY V2'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/hermawanrisky02'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6285803639392'; // Nomor whatsapplu cok
const aktif = 'SUKA SUKA GUA'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/JYNCOeG5OGcDanlqtIPuJj'; // OFFICIAL GRUP LU 1
const youtube = 'https://youtube.com/channel/UCFP1cgQfnbLpkB3DEshAAsw'; // OFFICIAL GRUP LU 2
//
...
conn.sendMessage(id, 'Owner RIZKI wa.me/+6285803639392' ,MessageType.text);
}
else if (text == 'Maslent'){
conn.sendMessage(id, 'Aku BOT nya RIZKI' ,MessageType.text);
}
else if (text == 'ZAHRA'){
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6285803639392* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh #help' ,MessageType.text);
}
...
conn.sendMessage(id, 'PEBRAY Add PEBRAY asik dia wa.me/+6285855579739' ,MessageType.text);
}
else if (text == ':)'){
conn.sendMessage(id, 'knp' ,MessageType.text);
}
else if (text == '.groupbot'){
conn.sendMessage(id, 'group bot whatsapp https://chat.whatsapp.com/JYNCOeG5OGcDanlqtIPuJj' ,MessageType.text);
}
else if (text == '.tools1'){
